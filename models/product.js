...
mongoose.model("Product", productSchema); //->products koleksiyonuna kaydedilecek
module.exports = mongoose.model("Product"); //->Product modelini dışa aktarır

//!OLD DATABASE CONNECTION USING MONGODB NATIVE DRIVER
